...
int puto(const void* self, FILE* fp) 
{
	const struct Class *class = classOf(self);
	assert(class->differ);
	return class->puto(self, fp);
}

/* Implemnet of Obect*/

void * Object_ctor (void * self, va_list * app)
{
	return self;
}
...
static void * Class_ctor (void * _self, va_list * app)
{
	...
	typedef void (* voidf) ();
	voidf selector;
	va_list ap = * app; /* generic function pointer */
...
/* Initailize of Class and that of Object */
